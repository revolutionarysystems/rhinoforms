...
public class RemoteSubmissionHelperTest {
    ...
    @Test
    public void testHandleSubmissionBadResultRedirect() throws FlowExceptionXPath, TransformerException, RemoteSubmissionHelperException {
        Submission submission = new Submission("http://localhost/dummyURL");
        submission.setOmitXmlDeclaration(true);
        submission.getData().put("xml", "[dataDocument]");
        submission.setResultInsertPoint("/myData");
        ...
        try{
            remoteSubmissionHelper.handleSubmission(submission, xsltParameters, formFlow);
            Assert.fail("Should have thrown Exception");
        }catch(RemoteSubmissionHelperRedirectException ex){
            // pass
            Assert.assertEquals("error", ex.getRedirectTarget());
        }
        
        testConnectionFactory.setResponseString("<submissionResult>one</submissionResult>");
        testConnectionFactory.setResponseCode(404);
        testConnectionFactory.setResponseMessage("Something went very wrong.");

        try{
            remoteSubmissionHelper.handleSubmission(submission, xsltParameters, formFlow);
            Assert.fail("Should have thrown Exception");
        }catch(RemoteSubmissionHelperException ex){
            // pass
        }
    }
    
    @Test
    public void testHandleSubmissionBadResultWildcardRedirect() throws FlowExceptionXPath, TransformerException, RemoteSubmissionHelperException {
        Submission submission = new Submission("http://localhost/dummyURL");
        submission.setOmitXmlDeclaration(true);
        submission.getData().put("xml", "[dataDocument]");
        submission.setResultInsertPoint("/myData");
        ErrorHandler errorHandler = new ErrorHandler("error");
        errorHandler.setCodeRegex("5[0-9][0-9]");
        submission.getErrorHandlers().add(errorHandler);
        testConnectionFactory.setResponseString("<submissionResult>one</submissionResult>");
        testConnectionFactory.setResponseCode(500);
        testConnectionFactory.setResponseMessage("Something went very wrong.");
    ...
    @Test
    public void testHandleSubmissionBadResultWildcardRedirect2() throws FlowExceptionXPath, TransformerException, RemoteSubmissionHelperException {
        Submission submission = new Submission("http://localhost/dummyURL");
        submission.setOmitXmlDeclaration(true);
        submission.getData().put("xml", "[dataDocument]");
        submission.setResultInsertPoint("/myData");
        ErrorHandler errorHandler1 = new ErrorHandler("error1");
        errorHandler1.setCodeRegex("404");
        submission.getErrorHandlers().add(errorHandler1);
        ErrorHandler errorHandler2 = new ErrorHandler("error2");
        errorHandler2.setCodeRegex("[0-9][0-9][0-9]");
        submission.getErrorHandlers().add(errorHandler2);
        testConnectionFactory.setResponseString("<submissionResult>one</submissionResult>");
        testConnectionFactory.setResponseCode(500);
        testConnectionFactory.setResponseMessage("Something went very wrong.");
        ...
        try{
            ...
            // pass
            Assert.assertEquals("error2", ex.getRedirectTarget());
        }
        ...
        try{
            ...
            // pass
            Assert.assertEquals("error1", ex.getRedirectTarget());
        }
    }
    
    @Test
    public void testHandleSubmissionBadResultTextRedirect() throws FlowExceptionXPath, TransformerException, RemoteSubmissionHelperException {
        Submission submission = new Submission("http://localhost/dummyURL");
        submission.setOmitXmlDeclaration(true);
        submission.getData().put("xml", "[dataDocument]");
        submission.setResultInsertPoint("/myData");
        ErrorHandler errorHandler = new ErrorHandler("error");
        errorHandler.setTextRegex(".* very wrong.");
        submission.getErrorHandlers().add(errorHandler);
        testConnectionFactory.setResponseString("<submissionResult>one</submissionResult>");
        testConnectionFactory.setResponseCode(500);
        testConnectionFactory.setResponseMessage("Something went very wrong.");
        ...
        testConnectionFactory.setResponseString("<submissionResult>one</submissionResult>");
        testConnectionFactory.setResponseCode(404);
        testConnectionFactory.setResponseMessage("Something went slightly wrong.");
    ...
    @Test
    public void testHandleSubmissionBadResultBodyRedirect() throws FlowExceptionXPath, TransformerException, RemoteSubmissionHelperException {
        Submission submission = new Submission("http://localhost/dummyURL");
        submission.setOmitXmlDeclaration(true);
        submission.getData().put("xml", "[dataDocument]");
        submission.setResultInsertPoint("/myData");
        ErrorHandler errorHandler = new ErrorHandler("error");
        errorHandler.setBodyRegex(".*one.*");
        submission.getErrorHandlers().add(errorHandler);
        testConnectionFactory.setResponseString("<submissionResult>one</submissionResult>");
        testConnectionFactory.setResponseCode(500);
        testConnectionFactory.setResponseMessage("Something went very wrong.");
        ...
        testConnectionFactory.setResponseString("<submissionResult>two</submissionResult>");
        testConnectionFactory.setResponseCode(404);
        testConnectionFactory.setResponseMessage("Something went very wrong.");
